...
import controller.ReservaControlador;
	...
	public ReservasView() {
	 ...
	 public void guardarReserva() {
		 try {
			 ...
			 reserva res = new reserva(java.sql.Date.valueOf(fechaEntrada), java.sql.Date.valueOf(fechaSalida), txtValor.getText(), txtFormaPago.getSelectedItem().toString());
	 ...
	 private void calcularValor(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
		 if(fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
			 ...
			 int dias = -1;
			 int noche = 12000; //precio del costo por noche
			 int valor;
